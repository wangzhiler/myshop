                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <button onclick="App.deleteMulti('/user/delete')" type="button" class="btn btn-sm btn-default"><i class="fa fa-trash-o"></i> 删除</button>&nbsp;&nbsp;&nbsp;
                ...
                },
                {
                    "data":function (row,type,val,meta) {
                        ...
                        return '<button onclick="App.showDetail(\'' + detailUrl + '\')" type="button" class="btn btn-sm btn-default">'
                            ...
                            + '<a href="/user/form?id=' + row.id + '" type="button" class="btn btn-sm btn-primary">'
                            + '<i class="fa fa-edit"></i>编辑</a>&nbsp;&nbsp;'
                            + '<button onclick="App.deleteMulti(\'/user/delete\')"  type="button" class="btn btn-sm btn-danger">'
